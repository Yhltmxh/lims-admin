...
基于 Spring Boot 3.5.16 的**前后端分离单体**项目，用于环境检测实验室的业务管理。
...
- [基础设施设计文档](docs/superpowers/specs/2026-07-12-lims-infrastructure-design.md)
- [实现计划](docs/superpowers/plans/2026-07-12-lims-infrastructure-plan.md)
- [开发规范](docs/开发规范.md)
- [开发文档](docs/dev.md)
