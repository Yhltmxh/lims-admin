...
import com.shou.mcmis.organize.log.service.LogSaveService;
...
class LogAspectTest {
    ...
    void shouldRecordSuccessLog() throws Throwable {
        ...
        ArgumentCaptor<com.shou.mcmis.organize.log.entity.Log> captor =
                ArgumentCaptor.forClass(com.shou.mcmis.organize.log.entity.Log.class);
        verify(logSaveService).saveLog(captor.capture());
        com.shou.mcmis.organize.log.entity.Log saved = captor.getValue();
